function [saida] = AxPPA_Trojan(a, b, K, W) 
           W=W+1;
           a= dec2bin(a, W);
           b= dec2bin(b, W);
           fim =length(a);
           for j = 1:fim
                    ...
                    T  = dec2bin(bitand(bin2dec(a(j, (W-K+1):W)) , bin2dec(b(j, (W-K+1):W))), K);
                    aux = dec2bin(bitxor(bin2dec(axppa_AND) , bin2dec(axppa_XOR)), K); 
                    
                    ss(j, (W-K+1):W) = dec2bin(bitxor(bin2dec(aux) , bin2dec(T)), K); 
